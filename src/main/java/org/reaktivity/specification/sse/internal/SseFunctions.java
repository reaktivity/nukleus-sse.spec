...
public final class SseFunctions
{
    ...
    public static final class SseRouteExBuilder
    {
        ...
        private SseRouteExBuilder()
        {
            ...
            this.routeExRW = new SseRouteExFW.Builder().wrap(writeBuffer, 0, writeBuffer.capacity());
        }

        public SseRouteExBuilder pathInfo(
            String pathInfo)
        {
            routeExRW.pathInfo(pathInfo);
            return this;
        }

        public byte[] build()
        {
            final SseRouteExFW routeEx = routeExRW.build();
